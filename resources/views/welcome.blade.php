        ...
        <div class="sendRequest">
            <div class="container">
                <div class="row">
                    ...
                    <form class="form-inline col-xs-12" action="" method="post">
            ...
            <div class="article container">
                <article class="main_article row jumbotron">
                    <div class="col-xs-12">
                        ...
                        <a class="btn btn-primary btn-md pull-left" href="#" role="button">המשך לקרוא</a>
                    </div>
                </article>
            </div>
        <!--</div>-->
...
<!--        <div class="sidebar1 col-sm-6 col-md-3">
            <h2>קידום <small> לורם איפסום דולור</small></h2>
            <p>
            ...
            <a class="btn btn-primary pull-right" href="#" role="button">המשך לקרוא</a>
        </div>-->
        <div class="sidebar1 col-sm-6 col-md-3 panel panel-default">
            ...
            <p>
                נולום ארווס סאפיאן - פוסיליס קוויס, אקווזמן קולורס מונפרד אדנדום סילקוף, מרגשי ומרגשח. עמחליף גולר
                        ...
                        <a class="btn btn-primary pull-left" href="#" role="button">המשך לקרוא</a>
    ...
    <div class="row">
        ...
        <div class="costumers col-xs-6 col-sm-6 col-md-3">
            ...
            נולום ארווס סאפיאן - פוסיליס קוויס, מרגשי ומרגשח. עמחליף גולר מונפרר סוברט 
                    ...
                    <p>
                         לורם איפסום דולור סיט אמט
          מרגשי ומרגשח. עמחליף גולר מונפרר סוברט 
                    </p>
                </div>
            </div>
        </div>
