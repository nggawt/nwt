        ...
        <div class="header_top">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="dial col-sm-1 hidden-xs pull-left">
                        ...
                        <div class="form_login hidden-xs col-sm-6 pull-right">
                            <form class="form-inline" action="{{ route('users.logIn') }}" method="post">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-default btn-sm" type="submit" name="submit">שלח <span class="glyphicon glyphicon-send costum" aria-hidden="true"></span></button>
                                </div>
...
<!--                            <div class="navBarCast navbar-header pull-right">
                            ...
                            <ul class="navCostom nav navbar-nav navbar-right col-sm-12 col-md-8">
                                <li class="hovered"><a href="{{ route('home') }}">דף הבית</a></li>
